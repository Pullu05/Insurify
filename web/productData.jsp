...
<section class="rounded mt-3 formBlock">
    <form action="AddProductData" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input  type="date" class="form-control" id="startDate" name="startDate" type="text" placeholder="MM/DD/YYYY" class="datepicker" value = "${product.startDate}">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <select id="insuranceSum" name="insuranceSum" class="form-control" value = "${product.insuranceSum}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <select id="meritRating" name="meritRating" class="form-control" value = "${product.meritRating}">
                    <option value="default">&ndash; please select &ndash;</option>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <select id="damageInsurance" name="damageInsurance" class="form-control" value = "${product.damageInsurance}">
                    <option value="default">&ndash; please select &ndash;</option>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <select id="courtesyCar" name="courtesyCar" class="form-control" value = "${product.courtesyCar}">
                    <option value="default">&ndash; please select &ndash;</option>
