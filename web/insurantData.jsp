...
<section class="rounded mt-3 formBlock">
    <form class="needs-validation" action="AddInsurantData" method = "post" onsubmit="submitFormAndChangeSection(event)" id="insurantDataForm" novalidate>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="email" id="email" class="form-control ${userEmail!=null?'is-valid':''}" name="email" value = "${userEmail}" readonly>
                <div class="invalid-feedback">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                ...
                <div class="invalid-feedback">
                    Please enter a valid aadhaar number (must be of 12 digits)
                </div>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                ...
                <div class="invalid-feedback">
                    Insurant must be at least 18 years old
                </div>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <select id="medicalRecord" name="medicalRecord" class="form-control" required>
                    ...
                    <div class="invalid-feedback">
                        Please select your medical history
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input id="gendermale" name="gender" class="form-check-input" type="radio" value="Male" required <c:if test = "${insurance.gender.equalsIgnoreCase('Male')}"> checked </c:if> required>
                    <label class="form-check-label me-2" for="gendermale">
                        Male
                    </label>

                    <input type="radio" id="genderfemale" name="gender" class="form-check-input" value="Female" required <c:if test = "${insurance.gender == 'Female'}"> checked </c:if> required>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                ...
                <div class="invalid-feedback">
                    Please give your website url (if any)
                </div>
            </div>
        </div>
