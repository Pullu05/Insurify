<%-- 
    Document   : insurantData
    Created on : 21-Feb-2023, 2:22:26 pm
...
<html>
    <head>
        ...
        <title>Enter Insurant Data</title>
    ...
    <body>
        <section id="insurantData" class="rounded  border border-dark mt-3">
            <form>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input id="birthdate" class="form-control" name="Date of Birth" type="date" placeholder="MM/DD/YYYY" class="datepicker">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input id="streetaddress" class="form-control" name="Street Address" type="text">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input id="zipcode" class="form-control" name="Zip Code" type="text">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <p class="row">
                            <label>
                                <input id="speeding" name="Hobbies" type="checkbox" value="Speeding"> Speeding</label>
                            <label>
                                <input id="bungeejumping" name="Hobbies" type="checkbox" value="BungeeJumping"> Bungee Jumping</label>
                            <label>
                                <input id="cliffdiving" name="Hobbies" type="checkbox" value="CliffDiving"> Cliff Diving</label>
                            <label>
                                <input id="skydiving" name="Hobbies" type="checkbox" value="Skydiving"> Skydiving</label>
                            <label>
                                <input id="other" name="Hobbies" type="checkbox" value="Other"> Other</label>
                        </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input id="picturecontainer" class="form-control" name="Picture Container" type="file" multiple>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-4 col-form-label"></label>
                    <div class="col-sm-6">
                        <button type="button" class="btn btn-dark" id="next_Btn">Next</button>
                        <button type="button" class="btn btn-dark" id="next_Btn">Prev</button>
                    </div>
                </form>
            </section>
