...
<html>
    <head>
        ...
        <style>
            ...
            #EuroProtection,#LegalDefenseInsurance{
                margin-right: 1rem;
            }
        </style>
    ...
    <body>
        <section id="productdata" class="rounded  border border-dark mt-3">
            <form>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <button type="button" class="btn btn-dark" id="next_Btn">&laquo;Prev</button>
