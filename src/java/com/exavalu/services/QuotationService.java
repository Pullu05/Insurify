...
public class QuotationService {
     ...
     * Data into the DB
     * @param quotation it consists of all the vehicle details and the premium details along with the plan name and quotation date
     ...
     * @param quotaionId it is the id by which different quotations generated by the user will be identified uniquely
     ...
     * @param quotaionId it is the id by which different quotations generated by the user will be identified uniquely
     * @param value it is the status value of a particular quotation (either accepted or rejected)
     * @return this method returns a boolean type which denotes the status of
...
//            System.out.println("SQL: " + preparedStatement);
    ...
    /**
     *
     * Description: The getAvgCoverage method is used to get the average coverage
     *
